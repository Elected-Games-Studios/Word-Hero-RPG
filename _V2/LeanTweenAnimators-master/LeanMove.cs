...
public class LeanMove : MonoBehaviour
{
    ...
    [SerializeField]
    private bool MoveToInitialOnDisable;
    #endregion
    #endregion
    ...
    {
        if (MoveToInitialOnDisable) //overrides repeatOnDisable if true
        {
            LeanTween.move(gameObject, startingPosition, GameMaster.GlobalScreenTransitionTimer).setEase(easingStyle).setDelay(.25f);
        }
    }
    #endregion
