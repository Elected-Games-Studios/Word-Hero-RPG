 ...
 public class SavedGamesScript : MonoBehaviour
{
    ...
    private static SavedGamesScript _instance;
    public static SavedGamesScript Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = new SavedGamesScript();
            }
            return _instance;
        }
    }
    ...
    private static string m_saveName = "WordHeroSave";
